...
class ShippingForm(forms.ModelForm):
    ...
    shipping_address2 = forms.CharField(label="" , widget=forms.TextInput(attrs={'class':'form-control' , 'placeholder':'Adress 2' ,}) , required=True)
...
class PaymentForm(forms.Form):
    ...
    card_exp_date = forms.CharField(label="" , widget=forms.TextInput(attrs={'class':'form-control' , 'placeholder':'Card Validation' ,}) , required=True)
